...
export default function ResetPassword() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setError(err.response?.data?.error || 'Şifre sıfırlanamadı. Link geçersiz veya süresi dolmuş olabilir.');
    } finally {
      setLoading(false);
    }
  };
      ...
      <div className="login-container">
        ...
        <div className="login-card">
          <div className="login-header">
            ...
            <h1 className="login-title">Şifre Güncellendi!</h1>
            <p className="login-subtitle">Şifreniz başarıyla değiştirildi. Giriş sayfasına yönlendiriliyorsunuz...</p>
          </div>
        </div>
      </div>
    );
    ...
    <div className="login-container">
      ...
      <div className="login-card">
        <div className="login-header">
          ...
          <p className="login-subtitle">Yeni şifrenizi oluşturun</p>
        </div>
        ...
        <div className="login-footer">
          <p className="text-sm text-secondary">
            <a href="/login" style={{ color: 'var(--primary)', textDecoration: 'none' }}>← Giriş sayfasına dön</a>
          </p>
        </div>
      </div>
    </div>
